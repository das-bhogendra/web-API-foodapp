...
export default function Header() {
  ...
  const { user, logout } = useAuth(); // Logged in user state
            ...
            <div className="hidden sm:flex items-center gap-2">
              {user ? (
                <>
                  ...
                  <button
                    onClick={() => logout()}
                    className="h-9 px-3 inline-flex items-center justify-center rounded-md bg-red-500 text-white text-sm font-semibold hover:opacity-90 transition-opacity"
                  >
                    Logout
                  </button>
                </>
                ...
                {user ? (
                  <>
                    ...
                    <button
                      ...
                      className="flex-1 h-9 px-3 inline-flex items-center justify-center rounded-md bg-red-500 text-white text-sm font-semibold hover:opacity-90 transition-opacity"
                    >
                      Logout
                    </button>
                  </>
