...
export default function ThemeToggle() {
  ...
  // Apply theme to html[data-theme] and persist in localStorage
  useEffect(() => {
  ...
  return (
    ...
    >
      {theme === "dark" ? (
        ...
        // Sun icon
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
          <path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Zm0 4.5a.75.75 0 0 0 .75-.75v-1.5a.75.75 0 0 0-1.5 0v1.5c0 .414.336.75.75.75Zm0-19.5a.75.75 0 0 0 .75-.75V.75a.75.75 0 0 0-1.5 0v1.5c0 .414.336.75.75.75Z" />
        </svg>
      ) : (
